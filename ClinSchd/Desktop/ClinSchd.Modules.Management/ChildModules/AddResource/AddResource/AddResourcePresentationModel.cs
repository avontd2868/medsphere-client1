...
{
	public class AddResourcePresentationModel : IAddResourcePresentationModel, INotifyPropertyChanged
    {
		...
		public AddResourcePresentationModel(IAddResourceView view,
		...
		public void AddEditClinic ()
		{
			...
			if (this.IsInactive) {
				...
				ResourceWaitlistPresentationModel waitListModel = new ResourceWaitlistPresentationModel (new ResourceWaitlistView (), this.dataAccessService, this.SchdResource.RESOURCEID);
		...
		public IAddResourceView View { get; private set; }
